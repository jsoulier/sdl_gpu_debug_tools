    ...
    const SDL_GPUTextureFormat depth_format)
{
    ...
    if (SDL_GetGPUShaderFormats(device) & SDL_GPU_SHADERFORMAT_SPIRV) {
        fragment_shader_info.code = shaders_shader_frag_spv;
        vertex_shader_info.code = shaders_shader_vert_spv;
        fragment_shader_info.code_size = shaders_shader_frag_spv_len;
        vertex_shader_info.code_size = shaders_shader_vert_spv_len;
        ...
        fragment_shader_info.code = shaders_shader_frag_dxil;
        vertex_shader_info.code = shaders_shader_vert_dxil;
        fragment_shader_info.code_size = shaders_shader_frag_dxil_len;
        vertex_shader_info.code_size = shaders_shader_vert_dxil_len;
        fragment_shader_info.entrypoint = "main";
        vertex_shader_info.entrypoint = "main";
        ...
        fragment_shader_info.code = shaders_shader_frag_msl;
        vertex_shader_info.code = shaders_shader_vert_msl;
        fragment_shader_info.code_size = shaders_shader_frag_msl_len;
        vertex_shader_info.code_size = shaders_shader_vert_msl_len;
